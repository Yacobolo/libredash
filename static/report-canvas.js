...
// web/components/report-canvas.ts
var ReportCanvas = class extends i4 {
  constructor() {
    super(...arguments);
    this.width = 1366;
    this.height = 768;
  ...
  positionVisuals() {
    ...
    for (const element of assigned) {
      ...
      this.positionVisual(element);
    }
  }
  positionVisual(element) {
    const x2 = parseCanvasNumber(element.dataset.x, 0);
    const y3 = parseCanvasNumber(element.dataset.y, 0);
...
__decorateClass([
  n4({ type: Number })
], ReportCanvas.prototype, "width", 2);
__decorateClass([
  n4({ type: Number })
], ReportCanvas.prototype, "height", 2);
__decorateClass([
  r5()
], ReportCanvas.prototype, "scale", 2);
__decorateClass([
  r5()
], ReportCanvas.prototype, "filtersOpen", 2);
function parseCanvasNumber(value, fallback) {
