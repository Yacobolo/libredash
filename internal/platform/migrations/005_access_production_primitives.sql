...
VALUES
  ('role_owner', 'owner', '["USE_WORKSPACE","VIEW_ITEM","EDIT_ITEM","MANAGE_ITEM","QUERY_DATA","PREVIEW_DATA","REFRESH_DATA","DEPLOY","ACTIVATE_DEPLOYMENT","USE_AGENT","VIEW_AGENT","MANAGE_GRANTS","VIEW_AUDIT","MANAGE_WORKSPACE"]'),
  ('role_admin', 'admin', '["USE_WORKSPACE","VIEW_ITEM","EDIT_ITEM","MANAGE_ITEM","QUERY_DATA","PREVIEW_DATA","REFRESH_DATA","DEPLOY","ACTIVATE_DEPLOYMENT","USE_AGENT","VIEW_AGENT","MANAGE_GRANTS","VIEW_AUDIT","MANAGE_WORKSPACE"]'),
