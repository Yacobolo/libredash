...
var apigenOperationPermissions = map[string]string{
	...
	"createRefreshRun":             access.PermissionMaterializationRun,
	"listRefreshRuns":              access.PermissionMaterializationRun,
	"getRefreshRun":                access.PermissionMaterializationRun,
