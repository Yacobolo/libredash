...
var apigenOperationPrivileges = map[string]access.Privilege{
	...
	"createDeploymentCandidate":            access.PrivilegeDeploy,
	"uploadDeploymentCandidateArtifact":    access.PrivilegeDeploy,
	"validateDeploymentCandidate":          access.PrivilegeDeploy,
