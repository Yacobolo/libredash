...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_QUERY_RESULT_MAX_BYTES", Field: "QueryResultMaxBytes", Type: TypeInt64, Default: "33554432", Category: "analytics", Scope: "serve", Description: "Maximum estimated retained bytes for one logical analytical operation.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUERY_CACHE_RUNTIME_MAX_BYTES", Field: "QueryCacheRuntimeMaxBytes", Type: TypeInt64, Default: "67108864", Category: "analytics", Scope: "serve", Description: "Maximum estimated cached result bytes retained by one serving generation.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUERY_CACHE_WORKSPACE_MAX_BYTES", Field: "QueryCacheWorkspaceMaxBytes", Type: TypeInt64, Default: "134217728", Category: "analytics", Scope: "serve", Description: "Maximum estimated cached result bytes retained across one workspace's serving generations.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUERY_CACHE_NODE_MAX_BYTES", Field: "QueryCacheNodeMaxBytes", Type: TypeInt64, Default: "536870912", Category: "analytics", Scope: "serve", Description: "Maximum estimated cached result bytes retained by the node.", Runtime: true, Lifecycle: "supported", Commented: true},
