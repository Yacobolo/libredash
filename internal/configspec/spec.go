...
var settings = []Setting{
	...
	{Name: "LIBREDASH_CATALOG_PATH", Field: "CatalogPath", Type: TypeString, Category: "storage", Scope: "serve", Description: "Legacy dashboard catalog path override.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LIBREDASH_PERF_ITERATIONS", Type: TypeInt, Default: "5", Category: "development", Scope: "MovieLens performance QA", Description: "Measured interaction iterations run by the MovieLens performance QA scenario.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_ENFORCE_THRESHOLDS", Type: TypeBool, Default: "false", Category: "development", Scope: "MovieLens performance QA", Description: "Fail MovieLens performance QA when phase latency or query-count thresholds are exceeded.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_LOG", Type: TypeString, Default: ".tmp/dev-server.log", Category: "development", Scope: "MovieLens performance QA", Description: "Development server log consumed by the MovieLens performance QA scenario.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_MAX_ALL_TARGET_P95_MS", Type: TypeInt, Default: "1000", Category: "development", Scope: "MovieLens performance QA", Description: "Maximum all-target settlement p95 when performance thresholds are enforced.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_MAX_CRITICAL_KPI_P95_MS", Type: TypeInt, Default: "1000", Category: "development", Scope: "MovieLens performance QA", Description: "Maximum critical-KPI settlement p95 when performance thresholds are enforced.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_MAX_FIRST_TARGET_PAINT_P95_MS", Type: TypeInt, Default: "500", Category: "development", Scope: "MovieLens performance QA", Description: "Maximum first-target paint p95 when performance thresholds are enforced.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_MAX_OPTIMISTIC_FEEDBACK_P95_MS", Type: TypeInt, Default: "16", Category: "development", Scope: "MovieLens performance QA", Description: "Maximum local optimistic-feedback p95 when performance thresholds are enforced.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_MAX_QUERIES", Type: TypeInt, Default: "4", Category: "development", Scope: "MovieLens performance QA", Description: "Maximum physical queries per measured refresh when performance thresholds are enforced.", Lifecycle: "development"},
	{Name: "LIBREDASH_PERF_OUTPUT", Type: TypeString, Default: ".tmp/movielens-performance.json", Category: "development", Scope: "MovieLens performance QA", Description: "JSON output path written by the MovieLens performance QA scenario.", Lifecycle: "development"},
